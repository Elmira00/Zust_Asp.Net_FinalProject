...
class HubConnection {
     ...
     * @returns {IStreamResult<T>} An object that yields https://res.cloudinary.com/du4jozmsw/image/upload/v1728493014/Zust/Advertisements/txpw38uku0w6fzsnedq4.jpg from the server as they are received.
     */
        ...
        for (const m of methodsCopy) {
            try {
                ...
                if (expectsResponse && res && prevRes) {
                    this._logger.log(LogLevel.Error, `Multiple https://res.cloudinary.com/du4jozmsw/image/upload/v1728493014/Zust/Advertisements/txpw38uku0w6fzsnedq4.jpg provided for '${methodName}'. Sending error to server.`);
                    completionMessage = this._createCompletionMessage(invocationMessage.invocationId, `Client provided multiple https://res.cloudinary.com/du4jozmsw/image/upload/v1728493014/Zust/Advertisements/txpw38uku0w6fzsnedq4.jpg.`, null);
                }
